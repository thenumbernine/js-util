...
var luaVmPackageInfos = {
	...
	symmath : {
		...
		tests : [	
			...
			{url:'/symbolic-lua/src/tests/NaturalUnits.lua', dest:'symmath/tests/NaturalUnits.lua'},
			{url:'/symbolic-lua/src/tests/mhd_symmetrization.lua', dest:'symmath/tests/mhd_symmetrization.lua'},
			{url:'/symbolic-lua/src/tests/newton_method.lua', dest:'symmath/tests/newton_method.lua'},
			{url:'/symbolic-lua/src/tests/RotationGroup.lua', dest:'symmath/tests/RotationGroup.lua'},
			{url:'/symbolic-lua/src/tests/EMConnKerrNewman_BlackHoleElectron.lua', dest:'symmath/tests/EMConnKerrNewman_BlackHoleElectron.lua'},
			{url:'/symbolic-lua/src/tests/EMConnUniformField.lua', dest:'symmath/tests/EMConnUniformField.lua'},
			{url:'/symbolic-lua/src/tests/spring_force.lua', dest:'symmath/tests/spring_force.lua'},
			{url:'/symbolic-lua/src/tests/Electrovacuum.lua', dest:'symmath/tests/Electrovacuum.lua'},
			...
			{url:'/symbolic-lua/src/tests/EFEExpr.lua', dest:'symmath/tests/EFEExpr.lua'},
			{url:'/symbolic-lua/src/tests/EMConnInfiniteWireNoCharge.lua', dest:'symmath/tests/EMConnInfiniteWireNoCharge.lua'},
			{url:'/symbolic-lua/src/tests/unit/test.lua', dest:'symmath/tests/unit/test.lua'},
			{url:'/symbolic-lua/src/tests/unit/LinearSolver.lua', dest:'symmath/tests/unit/LinearSolver.lua'},
			{url:'/symbolic-lua/src/tests/unit/TensorUseCase.lua', dest:'symmath/tests/unit/TensorUseCase.lua'},
			{url:'/symbolic-lua/src/tests/unit/SubTensorAssignment.lua', dest:'symmath/tests/unit/SubTensorAssignment.lua'},
			{url:'/symbolic-lua/src/tests/unit/Matrix.lua', dest:'symmath/tests/unit/Matrix.lua'},
			{url:'/symbolic-lua/src/tests/MetricCatalogue.lua', dest:'symmath/tests/MetricCatalogue.lua'},
			{url:'/symbolic-lua/src/tests/EMConnUniformCylindrical.lua', dest:'symmath/tests/EMConnUniformCylindrical.lua'},
			{url:'/symbolic-lua/src/tests/hydrodynamics_worksheet.lua', dest:'symmath/tests/hydrodynamics_worksheet.lua'},
			{url:'/symbolic-lua/src/tests/EMConnInfiniteWire.lua', dest:'symmath/tests/EMConnInfiniteWire.lua'},
			{url:'/symbolic-lua/src/tests/EMConnUniformSpherical.lua', dest:'symmath/tests/EMConnUniformSpherical.lua'},
			...
			{url:'/symbolic-lua/src/tests/SchwarzschildSpherical.lua', dest:'symmath/tests/SchwarzschildSpherical.lua'},
			{url:'/symbolic-lua/src/tests/ADM_metric_mixed.lua', dest:'symmath/tests/ADM_metric_mixed.lua'},
			{url:'/symbolic-lua/src/tests/SchwarzschildCartesian.lua', dest:'symmath/tests/SchwarzschildCartesian.lua'},
			{url:'/symbolic-lua/src/tests/alcubierre.lua', dest:'symmath/tests/alcubierre.lua'},
			{url:'/symbolic-lua/src/tests/SchwarzschildSphericalToCartesian.lua', dest:'symmath/tests/SchwarzschildSphericalToCartesian.lua'},
			{url:'/symbolic-lua/src/tests/kaluza-klein.lua', dest:'symmath/tests/kaluza-klein.lua'},
			{url:'/symbolic-lua/src/tests/Gravitation_16.1.lua', dest:'symmath/tests/Gravitation_16.1.lua'},
			{url:'/symbolic-lua/src/tests/toy_1plus1_spacetime.lua', dest:'symmath/tests/toy_1plus1_spacetime.lua'},
			{url:'/symbolic-lua/src/tests/ScalarMetric.lua', dest:'symmath/tests/ScalarMetric.lua'},
			{url:'/symbolic-lua/src/tests/mhd_inverse.lua', dest:'symmath/tests/mhd_inverse.lua'},
			{url:'/symbolic-lua/src/tests/SpacetimeEmbeddingRadius.lua', dest:'symmath/tests/SpacetimeEmbeddingRadius.lua'},
			...
			{url:'/symbolic-lua/src/tests/ADM_metric.lua', dest:'symmath/tests/ADM_metric.lua'},
			{url:'/symbolic-lua/src/tests/tensor_coord_invariance.lua', dest:'symmath/tests/tensor_coord_invariance.lua'},
			{url:'/symbolic-lua/src/tests/Gravitation_16.1_expr.lua', dest:'symmath/tests/Gravitation_16.1_expr.lua'},
			{url:'/symbolic-lua/src/tests/Gravitation_16.1_mixed.lua', dest:'symmath/tests/Gravitation_16.1_mixed.lua'},
			{url:'/symbolic-lua/src/tests/EMVerifyCylinderTransform.lua', dest:'symmath/tests/EMVerifyCylinderTransform.lua'}
		]
	},
	tensor : {
		files : [
