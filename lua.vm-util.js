...
var luaVmPackageInfos = {
	...
	symmath : {
		files : [
			...
			{url:'/symbolic-lua/src/diffgeom.lua', dest:'symmath/diffgeom.lua'},
		...
		tests : [
			...
			{url:'/symbolic-lua/src/tests/gravitation_16_1_mixed.lua', dest:'symmath/tests/gravitation_16_1_mixed.lua'},
			...
			{url:'/symbolic-lua/src/tests/natural_units.lua', dest:'symmath/tests/natural_units.lua'},
			...
			{url:'/symbolic-lua/src/tests/numerical_relativity_codegen.lua', dest:'symmath/tests/numerical_relativity_codegen.lua'},
			{url:'/symbolic-lua/src/tests/polar_geodesic.lua', dest:'symmath/tests/polar_geodesic.lua'},
			{url:'/symbolic-lua/src/tests/scalar_metric.lua', dest:'symmath/tests/scalar_metric.lua'},
			...
			{url:'/symbolic-lua/src/tests/schwarzschild_spherical_to_cartesian.lua', dest:'symmath/tests/schwarzschild_spherical_to_cartesian.lua'},
			{url:'/symbolic-lua/src/tests/spacetime_embedding_radius.lua', dest:'symmath/tests/spacetime_embedding_radius.lua'},
			...
			{url:'/symbolic-lua/src/tests/subtensor-assignment.lua', dest:'symmath/tests/subtensor-assignment.lua'},
			{url:'/symbolic-lua/src/tests/tensor-usecase.lua', dest:'symmath/tests/tensor-usecase.lua'},
