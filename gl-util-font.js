...
GL.Font = new function() {
	var thiz = this;
	GL.oninit.push(function() { thiz.init(); });
	var gl;
	...
	this.draw = function(posX, posY, fontSizeX, fontSizeY, text, sizeX, sizeY, colorR, colorG, colorB, colorA, dontRender, singleLine) {
		var cursorX = 0;
		var cursorY = 0;
		var maxx = 0;
