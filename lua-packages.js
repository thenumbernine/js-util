...
const luaPackages = {
	...
	['symmath'] : [
		...
		{from : '/lua/symmath/export', to : 'symmath/export', files : [
			'C.lua',
			'Console.lua',
			'Export.lua',
			'GnuPlot.lua',
		...
		{from : '/lua/symmath/matrix', to : 'symmath/matrix', files : [
			'determinant.lua',
			'diagonal.lua',
			'eigen.lua',
			'EulerAngles.lua',
		...
		{from : '/lua/symmath/op', to : 'symmath/op', files : [
			'add.lua',
			'approx.lua',
			'Binary.lua',
			'div.lua',
		...
		{from : '/lua/symmath/physics', to : 'symmath/physics', files : [
			'diffgeom.lua',
			'Faraday.lua',
			'MatrixBasis.lua',
			'StressEnergy.lua',
		...
		{from : '/lua/symmath/set', to : 'symmath/set', files : [
			'Complex.lua',
			'EvenInteger.lua',
			'Integer.lua',
			'Natural.lua',
		...
		{from : '/lua/symmath/tests', to : 'symmath/tests', files : [
			'Acoustic Black Hole.lua',
			'ADM formalism.lua',
			'ADM gravity using expressions.lua',
			'ADM Levi-Civita.lua',
			'ADM metric.lua',
			'ADM metric - mixed.lua',
			'Alcubierre.lua',
			'black hole brain.lua',
			'BSSN - generate.lua',
			'BSSN - index - cache.lua',
			'BSSN - index.lua',
			'Building Curvature by ADM.lua',
			'console_spherical_metric.lua',
			'Divergence Theorem in curvilinear coordinates.lua',
			'EFE discrete solution - 1-var.lua',
			'EFE discrete solution - 2-var.lua',
			'Einstein field equations - expression.lua',
			'Ernst.lua',
			'Euler Angles in Higher Dimensions.lua',
			'Euler fluid equations - flux eigenvectors.lua',
			'Euler fluid equations - primitive form.lua',
			'Faraday tensor in general relativity.lua',
			'Faraday tensor in special relativity.lua',
			'Finite Difference Coefficients.lua',
			'FiniteVolume.lua',
			'FLRW.lua',
			'GLM-Maxwell equations - flux eigenvectors.lua',
			'Gravitation 16.1 - dense.lua',
			'Gravitation 16.1 - expression.lua',
			'Gravitation 16.1 - mixed.lua',
			'hydrodynamics.lua',
			'hyperbolic gamma driver in ADM terms.lua',
			'imperial units.lua',
			'Kaluza-Klein - dense.lua',
			'Kaluza-Klein - index.lua',
			'Kaluza-Klein - real world values.lua',
			'Kaluza-Klein - varying scalar field - index.lua',
			'Kerr metric of Earth.lua',
			'Kerr-Schild degenerate case.lua',
			'Kerr-Schild - dense.lua',
			'Kerr-Schild - expression.lua',
			'KOE.lua',
			'Lorentz group.lua',
			'MakeTrigLookupTables.lua',
			'Maxwell equations - flux eigenvectors.lua',
			'metric catalog.lua',
			'MHD - flux eigenvectors.lua',
			'MHD inverse.lua',
			'MHD symmetrization.lua',
			'natural units.lua',
			'Navier-Stokes-Wilcox - flux eigenvectors.lua',
			'Newton method.lua',
			'numeric integration.lua',
			'Platonic Solids.lua',
			'remove beta from adm metric.lua',
			'rotation group.lua',
			'run all tests.lua',
			'scalar metric.lua',
			'Schwarzschild - isotropic.lua',
			'Schwarzschild - spherical - derivation.lua',
			'Schwarzschild - spherical - derivation - varying time 2.lua',
			'Schwarzschild - spherical - derivation - varying time.lua',
			'Schwarzschild - spherical.lua',
			'Schwarzschild - spherical - mass varying with time.lua',
			'Shallow Water equations - flux eigenvectors.lua',
			'simple_ag.lua',
			'spacetime embedding radius.lua',
			'spinors.lua',
			'spring force.lua',
			'SRHD_1D.lua',
			'SRHD.lua',
			'sum of two metrics.lua',
			'tensor coordinate invariance.lua',
			'TOV.lua',
			'toy-1+1 spacetime.lua',
			'wave equation in spacetime - flux eigenvectors.lua',
			'wave equation in spacetime.lua',
			'Z4 - flux PDE noSource.lua',
			'Z4 - flux PDE noSource usingOnlyUs.lua',
			'Z4.lua',
			'BSSN.symmath',
			'EM Connection for Stress Energy 2.symmath',
			'EM Connection for Stress Energy.symmath',
			'Euler fluid equations - flux eigenvectors.symmath',
			'Gravitation 16.1 - dense.symmath',
			'Gravitation 16.1 - expression.symmath',
			'Gravitation ch35.symmath',
			'Kaluza-Klein.symmath',
			'Riemann From Stress-Energy.symmath',
			'Z4 - compute flux eigenmodes - withGauge.symmath',
			'Z4 - compute flux eigenmodes.symmath',
			'Z4 metric-invariant.symmath',
			'plane wave MTW 35.11.symmath',
			'plane wave MTW 35.9.symmath',
			'speed of light to length of day.symmath',
			'spinors and tensor charts.symmath',
			'worksheet_spherical_metric.symmath',
			'worksheet_spherical_metric_using_eqs.symmath',
		]},
		{from : '/lua/symmath/tests/electrovacuum', to : 'symmath/tests/electrovacuum', files : [
			'black hole electron.lua',
			'general case.lua',
			'infinite wire.lua',
			'infinite wire no charge.lua',
			'uniform field - Cartesian.lua',
			'uniform field - cylindrical.lua',
			'uniform field - spherical.lua',
			'verify cylindrical transform.lua'
		]},
		{from : '/lua/symmath/tests/unit', to : 'symmath/tests/unit', files : [
			'compile.lua',
			'determinant_performance.lua',
			'export.lua',
			'func.lua',
			'getIndexesUsed.lua',
			'index_construction.lua',
			'integral.lua',
			'limit.lua',
			'linear solver.lua',
			'match.lua',
			...
			'solve.lua',
			'sqrt.lua',
			'symmetrizeIndexes.lua',
			'tensor sub-assignment.lua',
			'tensor sub-index.lua',
			'tensor use case.lua',
			'test.lua',
			'tidyIndexes.lua',
			'unit.lua',
			'Variable dependsOn.lua'
		]},
		{from : '/lua/symmath/tensor', to : 'symmath/tensor', files : [
			'Chart.lua',
			'DenseCache.lua',
			'dual.lua',
			'Index.lua',
		...
		{from : '/lua/symmath/visitor', to : 'symmath/visitor', files : [
			'DistributeDivision.lua',
			'Expand.lua',
			'ExpandPolynomial.lua',
			'FactorDivision.lua',
			'Factor.lua',
			'Prune.lua',
			'Tidy.lua',
